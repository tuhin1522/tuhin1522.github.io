    ...
    <>
      ...
      <section className="relative overflow-hidden py-20 sm:py-28">
        ...
        <div className="section-inner fade-in text-center">
          <span className="badge-ai text-xs font-semibold uppercase tracking-widest">Contact</span>
          <h1 className="mt-4 font-display text-4xl font-bold text-slate-900 dark:text-white sm:text-5xl">
            Let&apos;s <span className="text-gradient">Connect</span>
          </h1>
          <p className="mx-auto mt-6 max-w-xl text-base text-slate-600 dark:text-slate-300 sm:text-lg">
          ...
          <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] items-start">
            ...
            <div className="space-y-6 fade-in">
              ...
              <div className="space-y-3">
                ...
                <div className="card flex items-center gap-4">
                  <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-emerald-50 text-xl dark:bg-emerald-950/50">🟢</span>
                  <div>
                    <p className="text-xs font-semibold uppercase tracking-wide text-slate-400">Status</p>
                    <p className="text-sm font-medium text-emerald-600 dark:text-emerald-400">Available for opportunities</p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <SocialLink href={contact.github} label="GitHub — tuhin1522" icon={githubIcon} />
                <SocialLink href={contact.linkedin} label="LinkedIn — Md Tuhin Molla" icon={linkedinIcon} />
                <SocialLink href={`mailto:${contact.email}`} label={contact.email} icon={emailIcon} />
              </div>
